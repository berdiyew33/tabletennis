<template>
  <div>
    ...
    <Racket :positionX="racket1X + 'px'" :positionY="racket1Y + 'px'" color="#ff0000"  @mousedown="racket1Active = true" @touchstart="racket1Active = true" @mouseup="racket1Active = false" @touchend="racket1Active = false"/>
    <Racket :positionX="racket2X + 'px'" :positionY="racket2Y + 'px'" color="#0000ff"  @mousedown="racket2Active = true" @touchstart="racket2Active = true" @mouseup="racket2Active = false" @touchend="racket2Active = false"/>
